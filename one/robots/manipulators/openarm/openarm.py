...
jnt_ax = {
    ...
    "rgt_jnt7": ouc.StandardAxis.Y,
}  # y


def link(prefix, name, idx, mesh_dir, rgb=ouc.ExtendedColor.DEEP_GRAY):
    loc_pos = lnk_pos[idx]
    mass = lnk_mass[idx]
    com = lnk_com[idx]
...
def prepare_arm_ms(prefix="lft"):
    ...
    lnk6 = link(prefix, "link6", 6, mesh_dir, rgb=ouc.ExtendedColor.STEEL_GRAY)
...
if __name__ == "__main__":
    ...
    base = ovw.World(cam_pos=[1.2, 0.5, 1.3], cam_lookat_pos=[0, 0, 0.5])
    openarm = OpenArm()
