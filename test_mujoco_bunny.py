...
base = wd.World(cam_pos=(.75, 1.5, 1.5), toggle_auto_cam_orbit=False)
builtins.base = base
...
plane_left = prims.gen_plane(pos=(0, .35, 0), size=(.7, .7),
                             normal=-const.StandardAxis.Y,
                             alpha=const.ALPHA.TRANSPARENT)
plane_left.attach_to(base.scene)
plane_right = prims.gen_plane(pos=(0, -.35, 0), size=(.7, .7),
                              normal=const.StandardAxis.Y,
                              alpha=const.ALPHA.TRANSPARENT)
plane_right.attach_to(base.scene)
plane_front = prims.gen_plane(pos=(.35, 0, 0), size=(.7, .7),
                              normal=-const.StandardAxis.X,
                              alpha=const.ALPHA.TRANSPARENT)
plane_front.attach_to(base.scene)
plane_back = prims.gen_plane(pos=(-.35, 0, 0), size=(.7, .7),
                             normal=const.StandardAxis.X,
                             alpha=const.ALPHA.TRANSPARENT)
